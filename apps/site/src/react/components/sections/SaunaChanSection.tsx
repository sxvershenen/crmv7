...
interface SaunaChanSectionProps { config: CmsHomeSectionConfig; onAddAddon: (addonName: string) => void; onOpenBookingModal?: (itemName?: string) => void; onToast: (message: string) => void }

export function SaunaChanSection({ config, onAddAddon, onToast }: SaunaChanSectionProps) {
