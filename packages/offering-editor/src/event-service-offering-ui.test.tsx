...
function data(): EventServiceEditorData {
  ...
  return {
    dossier: {
      offering: { id: ids.offering, code: "EVENT-WEDDING", version: 1, kind: "event_service", state: "active", operationalName: "Свадебное мероприятие", internalComment: "Внутренняя заметка", salesMode: "quoted", priceDisplayMode: "from", currency: "RUB", timezone: "Europe/Moscow", taxMode: "tax_included", businessCalendarId: "11111111-1111-4111-8111-111111111111", fulfillment: { kind: "event_service" }, activePriceBookId: ids.priceBook, archivedAt: null, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z" },
      template: { id: ids.template, code: "wedding_internal", version: 1, format: "wedding", icon: "heart", tone: "rose", defaultDurationMinutes: 240, minimumGuests: 10, maximumGuests: 80, preparationBeforeMinutes: 60, preparationAfterMinutes: 30, archivedAt: null, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z" },
...
describe("event category shared workspace", () => {
  it("shows one visible commercial identity and hides the technical template code", () => {
    ...
    expect(markup).toContain("Иконка")
    expect(markup).toContain("Цвет")
    expect(markup).toContain("Внутренняя заметка")
  })
