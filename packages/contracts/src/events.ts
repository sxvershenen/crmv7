...
export const EventTransitionSchema = z.object({ version: VersionSchema, operationId: OperationIdSchema, idempotencyKey: IdempotencyKeySchema, status: EventStatusSchema }).strict()
