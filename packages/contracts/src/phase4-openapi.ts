...
import { AddOnOfferingCreateBodySchema, AddOnOfferingCreateResultSchema, AddOnTermsMutationBodySchema, AddOnTermsMutationResultSchema, EventServiceOfferingCreateResultSchema, EventServiceOfferingDossierSchema, EventServiceOfferingLookupResultSchema, EventServiceOfferingPrepareBodySchema, EventServiceOfferingQuotePreviewBodySchema, EventServiceOfferingQuoteResultSchema, EventServiceTemplateCreateBodySchema, EventServiceTemplateMutationBodySchema, EventServiceTemplateMutationResultSchema, EventServiceTemplateRegistryQuerySchema, EventServiceTemplateRegistryResponseSchema, EventServiceTemplateReopenBodySchema, EventServiceTemplateReopenResultSchema, HousePriceBookActivateBodySchema, HousePriceBookDraftCreateBodySchema, HousePriceBookDraftReplaceBodySchema, HousePriceBookScheduleBodySchema, InternalHouseOfferingQuoteBodySchema, InternalOfferingEditorSchema, InternalOfferingQuoteResultSchema, OfferingBindingTargetLookupQuerySchema, OfferingBindingTargetLookupResponseSchema, OfferingEditorialLocatorSchema, OfferingListOpenApiQuerySchema, OfferingListResponseSchema, OfferingPricingMutationResultSchema, ProgramOfferingLookupResultSchema, ProgramOfferingPrepareBodySchema, ProgramOfferingPrepareResultSchema, ProgramOfferingQuotePreviewBodySchema, ProgramOfferingQuoteResultSchema, PublicAddOnListQuerySchema, PublicAddOnListResponseSchema, PublicAddOnSummaryParamsSchema, PublicAddOnSummarySchema, PublicHouseDetailQuerySchema, PublicHouseListQuerySchema, PublicHouseListResponseSchema, PublicHouseSummarySchema, PublicProgramListQuerySchema, PublicProgramListResponseSchema, PublicProgramSummaryParamsSchema, PublicProgramSummarySchema, PublicVenueListQuerySchema, PublicVenueListResponseSchema, PublicVenueSummaryParamsSchema, PublicVenueSummarySchema } from "./offerings.js";
...
const eventServiceTemplateRegistryQuery = adminRegister("EventServiceTemplateRegistryQuery", EventServiceTemplateRegistryQuerySchema);
const eventServiceTemplateRegistryResponse = adminRegister("EventServiceTemplateRegistryResponse", EventServiceTemplateRegistryResponseSchema);
const eventServiceTemplateCreate = adminRegister("EventServiceTemplateCreateBody", EventServiceTemplateCreateBodySchema);
const eventServiceOfferingCreateResult = adminRegister("EventServiceOfferingCreateResult", EventServiceOfferingCreateResultSchema);
const eventServiceOfferingDossier = adminRegister("EventServiceOfferingDossier", EventServiceOfferingDossierSchema);
const eventServiceTemplateMutation = adminRegister("EventServiceTemplateMutationBody", EventServiceTemplateMutationBodySchema);
const eventServiceTemplateMutationResult = adminRegister("EventServiceTemplateMutationResult", EventServiceTemplateMutationResultSchema);
const eventServiceTemplateReopen = adminRegister("EventServiceTemplateReopenBody", EventServiceTemplateReopenBodySchema);
const eventServiceTemplateReopenResult = adminRegister("EventServiceTemplateReopenResult", EventServiceTemplateReopenResultSchema);
const eventServiceOfferingLookupResult = adminRegister("EventServiceOfferingLookupResult", EventServiceOfferingLookupResultSchema);
const eventServiceOfferingPrepare = adminRegister("EventServiceOfferingPrepareBody", EventServiceOfferingPrepareBodySchema);
const eventServiceOfferingQuotePreview = adminRegister("EventServiceOfferingQuotePreviewBody", EventServiceOfferingQuotePreviewBodySchema);
const eventServiceOfferingQuoteResult = adminRegister("EventServiceOfferingQuoteResult", EventServiceOfferingQuoteResultSchema);
...
const eventServiceTemplateParams = adminRegister("EventServiceTemplateParams", z.object({ templateId: z.string().uuid() }).strict());
const eventServiceQuoteParams = adminRegister("EventServiceQuoteParams", z.object({ quoteId: z.string().uuid() }).strict());
...
adminRegistry.registerPath({ method: "get", path: "/event-services", ...adminPrivate, tags: ["Event services", "Offerings"], summary: "List EventServiceTemplate operational dossiers", request: { query: eventServiceTemplateRegistryQuery }, responses: { 200: { description: "Event-service template registry", content: json(eventServiceTemplateRegistryResponse) }, 403: errorResponse("Operational or content view capability denied", adminError) } });
adminRegistry.registerPath({ method: "post", path: "/event-services", ...adminPrivate, tags: ["Event services", "Offerings"], summary: "Create an EventServiceTemplate and its commercial identity atomically", request: { body: { required: true, content: json(eventServiceTemplateCreate) } }, responses: { 201: { description: "Event-service dossier created", content: json(eventServiceOfferingCreateResult) }, 409: errorResponse("Code, idempotency or legacy mapping conflict", adminError), 422: errorResponse("Event-service template is invalid", adminError) } });
adminRegistry.registerPath({ method: "get", path: "/event-services/templates/{templateId}", ...adminPrivate, tags: ["Event services", "Offerings"], summary: "Resolve an EventServiceTemplate dossier after reload", request: { params: eventServiceTemplateParams }, responses: { 200: { description: "Unprepared, linked or ambiguous event-service dossier", content: json(eventServiceOfferingLookupResult) }, 404: errorResponse("Event-service template not found", adminError) } });
adminRegistry.registerPath({ method: "patch", path: "/event-services/templates/{templateId}", ...adminPrivate, tags: ["Event services", "Offerings"], summary: "Update EventServiceTemplate terms with named subject CAS", request: { params: eventServiceTemplateParams, body: { required: true, content: json(eventServiceTemplateMutation) } }, responses: { 200: { description: "Event-service template updated", content: json(eventServiceTemplateMutationResult) }, 409: errorResponse("Template version or idempotency conflict", adminError), 422: errorResponse("Event-service template is invalid", adminError) } });
adminRegistry.registerPath({ method: "post", path: "/event-services/templates/{templateId}/prepare", ...adminPrivate, tags: ["Event services", "Offerings"], summary: "Prepare an event-service commercial identity and canonical editorial draft atomically", request: { params: eventServiceTemplateParams, body: { required: true, content: json(eventServiceOfferingPrepare) } }, responses: { 201: { description: "Event-service offering prepared", content: json(eventServiceOfferingDossier) }, 409: errorResponse("Template version, idempotency or legacy mapping conflict", adminError), 422: errorResponse("Event-service preparation is invalid", adminError) } });
adminRegistry.registerPath({ method: "post", path: "/event-services/templates/{templateId}/reopen", ...adminPrivate, tags: ["Event services", "Offerings"], summary: "Reopen an archived EventServiceTemplate with named subject CAS", request: { params: eventServiceTemplateParams, body: { required: true, content: json(eventServiceTemplateReopen) } }, responses: { 200: { description: "Event-service template reopened", content: json(eventServiceTemplateReopenResult) }, 409: errorResponse("Template version or idempotency conflict", adminError), 422: errorResponse("Event-service template cannot be reopened", adminError) } });
adminRegistry.registerPath({ method: "post", path: "/event-services/{offeringId}/quotes/preview", ...adminPrivate, tags: ["Event services", "Offerings"], summary: "Persist a private non-acceptance-ready event-service interval/package preview", request: { params: offeringIdParams, body: { required: true, content: json(eventServiceOfferingQuotePreview) } }, responses: { 200: { description: "Immutable event-service quote snapshot", content: json(eventServiceOfferingQuoteResult) }, 409: errorResponse("Idempotency or offering resolution conflict", adminError), 422: errorResponse("Event-service pricing or interval is invalid", adminError) } });
adminRegistry.registerPath({ method: "get", path: "/event-services/quotes/{quoteId}", ...adminPrivate, tags: ["Event services", "Offerings"], summary: "Reload an immutable event-service quote snapshot", request: { params: eventServiceQuoteParams }, responses: { 200: { description: "Immutable event-service quote snapshot", content: json(eventServiceOfferingQuoteResult) }, 404: errorResponse("Quote snapshot not found", adminError) } });
...
const publicHouseListQuery = publicRegister("PublicHouseListQuery", PublicHouseListQuerySchema);
const publicHouseList = publicRegister("PublicHouseListResponse", PublicHouseListResponseSchema);
const publicHouseDetailQuery = publicRegister("PublicHouseDetailQuery", PublicHouseDetailQuerySchema);
const publicHouseSummary = publicRegister("PublicHouseSummary", PublicHouseSummarySchema);
const publicCampgroundListQuery = publicRegister("PublicCampgroundListQuery", PublicCampgroundListQuerySchema);
const publicCampgroundList = publicRegister("PublicCampgroundListResponse", PublicCampgroundListResponseSchema);
const publicCampgroundDetailQuery = publicRegister("PublicCampgroundDetailQuery", PublicCampgroundDetailQuerySchema);
const publicCampgroundSummary = publicRegister("PublicCampgroundSummary", PublicCampgroundSummarySchema);
const publicVenueListQuery = publicRegister("PublicVenueListQuery", PublicVenueListQuerySchema);
const publicVenueList = publicRegister("PublicVenueListResponse", PublicVenueListResponseSchema);
const publicVenueSummaryParams = publicRegister("PublicVenueSummaryParams", PublicVenueSummaryParamsSchema);
const publicVenueSummary = publicRegister("PublicVenueSummary", PublicVenueSummarySchema);
const publicProgramListQuery = publicRegister("PublicProgramListQuery", PublicProgramListQuerySchema);
const publicProgramList = publicRegister("PublicProgramListResponse", PublicProgramListResponseSchema);
const publicProgramSummaryParams = publicRegister("PublicProgramSummaryParams", PublicProgramSummaryParamsSchema);
const publicProgramSummary = publicRegister("PublicProgramSummary", PublicProgramSummarySchema);
...
publicRegistry.registerPath({ method: "get", path: "/offerings/venues", tags: ["Offerings"], summary: "List release-pinned public venue summaries", request: { query: publicVenueListQuery }, responses: { 200: { description: "Published venue summary cursor page", headers: { ETag: { schema: { type: "string" } }, "Cache-Control": { schema: { type: "string" } } }, content: json(publicVenueList) }, 304: { description: "The ETag matches the published venue listing" }, 400: errorResponse("Unknown or invalid venue listing query", publicError), 404: errorResponse("Published venue listing not found", publicError), 503: errorResponse("Published venue projection is unavailable", publicError) } });
publicRegistry.registerPath({ method: "get", path: "/offerings/venues/{offeringId}", tags: ["Offerings"], summary: "Read one release-pinned public venue summary", request: { params: publicVenueSummaryParams }, responses: { 200: { description: "Published venue summary", headers: { ETag: { schema: { type: "string" } }, "Cache-Control": { schema: { type: "string" } } }, content: json(publicVenueSummary) }, 304: { description: "The ETag matches the published venue summary" }, 400: errorResponse("Invalid venue offering id", publicError), 404: errorResponse("Published venue not found", publicError), 503: errorResponse("Published venue projection is unavailable", publicError) } });
publicRegistry.registerPath({ method: "get", path: "/offerings/programs", tags: ["Offerings"], summary: "List release-pinned public program summaries", request: { query: publicProgramListQuery }, responses: { 200: { description: "Published program summary cursor page", headers: { ETag: { schema: { type: "string" } }, "Cache-Control": { schema: { type: "string" } } }, content: json(publicProgramList) }, 304: { description: "The ETag matches the published program listing" }, 400: errorResponse("Unknown or invalid program listing query", publicError), 404: errorResponse("Published program listing not found", publicError), 503: errorResponse("Published program projection is unavailable", publicError) } });
publicRegistry.registerPath({ method: "get", path: "/offerings/programs/{offeringId}", tags: ["Offerings"], summary: "Read one release-pinned public program summary", request: { params: publicProgramSummaryParams }, responses: { 200: { description: "Published program summary", headers: { ETag: { schema: { type: "string" } }, "Cache-Control": { schema: { type: "string" } } }, content: json(publicProgramSummary) }, 304: { description: "The ETag matches the published program summary" }, 400: errorResponse("Invalid program offering id", publicError), 404: errorResponse("Published program not found", publicError), 503: errorResponse("Published program projection is unavailable", publicError) } });
publicRegistry.registerPath({ method: "get", path: "/offerings/houses", tags: ["Offerings"], summary: "List release-pinned public house summaries", request: { query: publicHouseListQuery }, responses: { 200: { description: "Published house summary cursor page", headers: { ETag: { schema: { type: "string" } }, "Cache-Control": { schema: { type: "string" } } }, content: json(publicHouseList) }, 304: { description: "The ETag matches the published house listing" }, 404: errorResponse("Published house listing not found", publicError), 503: errorResponse("Published house projection is unavailable", publicError) } });
publicRegistry.registerPath({ method: "get", path: "/offerings/houses/detail", tags: ["Offerings"], summary: "Read one release-pinned public house summary by its canonical CMS path", request: { query: publicHouseDetailQuery }, responses: { 200: { description: "Published house summary", headers: { ETag: { schema: { type: "string" } }, "Cache-Control": { schema: { type: "string" } } }, content: json(publicHouseSummary) }, 304: { description: "The ETag matches the published house summary" }, 404: errorResponse("Published house not found", publicError), 503: errorResponse("Published house projection is unavailable", publicError) } });
