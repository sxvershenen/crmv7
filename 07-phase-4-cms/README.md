...
1. Закрыть отдельный ProgramRegistration acceptance gate: occurrence-bound immutable quote, authoritative capacity/concurrency, accepted quote link, lifecycle/audit/outbox и CRM conflict/requote UX. Template preview не принимать как цену регистрации.
